...
public class Produto {
    ...
    public static boolean verificarSeCodigoJaExiste(ProdutoDao dao, String codigo) throws SQLException {
        if (!Boolean.TRUE.equals(dao.verificarSeProdutoExiste(codigo))) {
            return true;
        }
        return false;
